<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FindID.aspx.cs" Inherits="BakingProject.FindID" %>
...
&nbsp;<asp:Button ID="Button1" runat="server" Text="중복확인" OnClick="Button1_Click" />
            ...
            <asp:Button ID="Button2" runat="server" Text="사용" OnClick="Button2_Click" />
            <br />
