...
namespace Last_Project.Board
{
    public partial class Reply : System.Web.UI.Page
    {
        ...
        {
            if (!IsPostBack) TextBox3.Text = "[RE] " + Request.QueryString["title"];
        }
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string sql2 = @"Update board Set inner_id = inner_id + 1
            ...
            string sql3 = @"Insert into board(name, pwd, title, body, ref_id, inner_id, depth, wDate, fName, fSize)
                                 Values (@name,@pwd,@title,@body,@ref_id,@inner_id,@depth, getDate( ),
                                        @fName, @fSize);";
            ...
            if (FileUpload1.HasFile) 
            {
                ...
                // 파일을 서버에 저장(full path name을 줘야 함)
