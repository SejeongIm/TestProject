<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Last_Project.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <tr>
 <td style="padding: 3px" class="auto-style5">사용할 아이디</td>
...
ValidationExpression="[0-9a-zA-Z]{4,10}"></asp:RegularExpressionValidator>
 ...
 <tr>
 <td style="padding: 3px" class="auto-style5">비밀번호</td>
 <td style="padding: 3px" class="auto-style5">
...
Display="None" ErrorMessage="[비밀번호] 필수입력"></asp:RequiredFieldValidator>
 ...
 <tr>
 <td style="padding: 3px" class="auto-style5">비밀번호 확인</td>
 <td style="padding: 3px" class="auto-style5">
...
ControlToValidate="TextBox3" Display="None" ErrorMessage="비밀번호가 일치하지 않습니다"></asp:CompareValidator></td>
 ...
 <tr>
 <td style="padding: 3px" class="auto-style5">이름</td>
 <td style="padding: 3px" class="auto-style5">
...
Display="None" ErrorMessage="[이름] 필수입력"></asp:RequiredFieldValidator>
 ...
 <tr>
 <td style="padding: 3px" class="auto-style5">전화번호</td>
 <td style="padding: 3px" class="auto-style3">
 <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
 </td>
 </tr>
 </table><br />
 <asp:Button ID="Button6" runat="server" Text="등록합니다" OnClick="Button6_Click" />&nbsp; <asp:Button ID="Button7" runat="server" CausesValidation="False" Text="Home 으로" OnClick="Button7_Click" /><br />
